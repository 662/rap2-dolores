...
export const RequestPropertyList = props => <PropertyList scope="request" title="请求参数" label="请求" {...props} />;
export const ResponsePropertyList = props => <PropertyList scope="response" title="响应内容" label="响应" {...props} />;
